...
class Solution {
public:
    vector<int> corpFlightBookings(vector<vector<int>>& bookings, int c) {
    int running = 0;vector<int> ans;
    int n = bookings.size(); int start = 1 , end = c;

    vector<int> flightLine(end + 2);
